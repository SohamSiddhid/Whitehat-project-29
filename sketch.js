...
function setup() {
  ...
  blockA = new Block(700,100,30,40);
  blockB = new Block(670,100,30,40);
  blockC = new Block(730,100,30,40);
  blockD = new Block(760,100,30,40);
  blockE = new Block(640,100,30,40);

  //Level 2

  blockF = new Block(700,50,30,40);
  blockG = new Block(670,50,30,40);
  blockH = new Block(730,50,30,40);

  //Level 3

  blockI = new Block(700,30,30,40);
